...
print("If read this is script worked!")
...
TextLabel.Text = "Touch Fling by Silly Nobby"
...
local function IIMAWH_fake_script() -- TextButton.LocalScript 
    ...
    local flingThread 
    if not ReplicatedStorage:FindFirstChild("ubisifj0i29x0eidspf0io3") then
        local detection = Instance.new("Decal")
        detection.Name = "ubisifj0i29x0eidspf0io3"
